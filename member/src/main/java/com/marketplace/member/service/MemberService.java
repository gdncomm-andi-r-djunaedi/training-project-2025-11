...
import com.marketplace.member.dto.*;
...
public class MemberService {
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        log.info("Login successful for member: {}", member.getId());
    ...
    public void logout(String token) {
        ...
        if (token != null && jwtTokenProvider.validateToken(token)) {
            ...
            log.info("Token blacklisted successfully, will expire in {} ms", remainingValidity);
        }
    }
