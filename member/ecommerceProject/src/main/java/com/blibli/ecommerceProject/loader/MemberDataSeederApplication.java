package com.blibli.ecommerceProject.loader;
...
//            log.error("Error writing password file: {}", e.getMessage());
    ...
    private MemberData createRandomMember(int index) {
        ...
        member.setAddress("Indonesia");
        member.setPassword(passwordEncoder.encode(plainPassword));
    ...
    private String generateValidPassword() {
        ...
        int remainingLength = 4 + random.nextInt(13);
