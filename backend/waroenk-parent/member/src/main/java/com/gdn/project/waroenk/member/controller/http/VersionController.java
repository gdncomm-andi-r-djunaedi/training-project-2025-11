...
import com.gdn.project.waroenk.member.mapper.VersionMapper;
...
@RestController("memberHttpVersionController")
public class VersionController {
  ...
  @Autowired
  public VersionController(@GrpcClient("member-service") VersionServiceGrpc.VersionServiceBlockingStub grpcClient) {
