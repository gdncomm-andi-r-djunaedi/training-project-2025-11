...
public class SystemParameterController extends CartSystemParameterServiceGrpc.CartSystemParameterServiceImplBase {
    ...
    @Override
    public void createSystemParameter(UpsertSystemParameterRequest request, StreamObserver<SystemParameterData> responseObserver) {
    ...
    @Override
    public void updateSystemParameter(UpsertSystemParameterRequest request, StreamObserver<SystemParameterData> responseObserver) {
        SystemParameter entity = mapper.toEntity(request);
    ...
    @Override
    public void findSystemParameterByVariable(OneSystemParameterRequest request, StreamObserver<SystemParameterData> responseObserver) {
    ...
    @Override
    public void filterSystemParameters(MultipleSystemParameterRequest request, StreamObserver<MultipleSystemParameterResponse> responseObserver) {
