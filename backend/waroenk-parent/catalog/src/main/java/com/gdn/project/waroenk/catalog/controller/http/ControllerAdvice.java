...
import com.gdn.project.waroenk.catalog.exceptions.InvalidCredentialsException;
...
import com.gdn.project.waroenk.catalog.utility.ExceptionTranslatorUtil;
...
@Slf4j
@Order(2)
@RestControllerAdvice(basePackages = "com.gdn.project.waroenk.catalog.controller.http")
