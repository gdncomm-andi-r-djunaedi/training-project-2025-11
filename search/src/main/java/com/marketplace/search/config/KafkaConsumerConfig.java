...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, ProductUpdateEvent> consumerFactory() {
        ...
        configProps.put(ConsumerConfig.GROUP_ID_CONFIG, "search-service-group");
    ...
    public ConcurrentKafkaListenerContainerFactory<String, ProductUpdateEvent> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, ProductUpdateEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
