#!/usr/bin/env python3
"""
Script to register the retry users from users_retry_unique.csv
This is a copy of register_users.py but uses the retry CSV file
"""
...
def main():
    csv_filename = "users_retry_unique.csv"
    
    print("=" * 60)
    print("Retry User Registration Script")
    print("=" * 60)
    ...
    if errors:
        error_filename = "retry_registration_errors.json"
