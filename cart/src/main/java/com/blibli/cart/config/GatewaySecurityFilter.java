...
/**
 * Security filter to verify requests came from the API Gateway
 * Prevents direct access to cart service bypassing gateway authentication
 */
@Slf4j
public class GatewaySecurityFilter implements Filter {
    ...
    /**
     * Generate expected gateway signature
     * Must match the signature generated by gateway's AuthGatewayFilterFactory
     */
